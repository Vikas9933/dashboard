-- =============================================================================
-- Multi-tenant architecture: clients (tenants) with isolated data
-- Run AFTER migrations 001–010
--
-- IMPORTANT: Run 011a_multi_tenant_enum.sql FIRST, then this file.
-- =============================================================================

-- 1. Tenant (client) table
...
-- 2. Default tenant for existing data (enum super_admin added in 011a)
...
-- Allow platform super_admin without agency (existing check only allowed admin)
...
-- 6. Enforce NOT NULL on business data
...
-- 9. Tenant helper functions
-- STOP: Do not run from here unless sections 1–8 completed (tenant_id columns exist).
-- If you hit "column tenant_id does not exist", run 011FINAL_run_after_011a.sql instead.
...
-- 10. Signup trigger with tenant assignment
...
-- 13. Update views with tenant_id (must DROP first — cannot REPLACE with new column order)
